# Contexto para Claude — carpeta "Salud (demo)"

> **FAMILIA DE EJEMPLO.** Todo lo que hay en esta carpeta es ficticio (personas, documentos, médicos, valores, cédulas). Sirve para aprender, probar y demostrar el agente de salud familiar sin exponer datos reales. Bórrala o reemplázala cuando montes tu carpeta real.

Carpeta raíz de toda la documentación de salud de la familia de **Camila Restrepo Gómez** (camila.demo@ejemplo.co): documentos médicos propios y de los familiares que se listan abajo. Todo vive en Google Drive (`G:\My Drive\Salud (demo)`).
...
| --- | --- | --- |
| `Papá\` | Jorge Restrepo Vélez, CC 00.000.001 (ficticia), nacido 12-mar-1955 (71 años). Padre de Camila. | Patrón documental completo (00-06): 2 laboratorios transcritos con tendencia, 1 nota de consulta, 1 orden médica. |
| `Camila\` | Camila Restrepo Gómez, CC 00.000.002 (ficticia), nacida 03-jul-1988. La dueña de la carpeta. | Sin carpeta aún — se crea con "quiero agregar un nuevo miembro" (caso de uso de la demo). |

La familia vive en Medellín. Jorge se atiende con la **EPS Ejemplo** (plan básico) en la IPS Demo Salud; su médica de cabecera es medicina interna. Camila tiene la misma EPS.
