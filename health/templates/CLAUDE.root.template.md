...
15. **Preguntas al equipo médico: estratégicas, desde la posición del médico.** Los médicos rara vez dejan que la familia entre en lo técnico, y menos en un entorno nuevo: una pregunta técnica (dosis, interacciones, por qué ese medicamento) se lee como desconfianza y cierra la conversación. Toda pregunta que el agente proponga para el médico o el personal arranca abierta y general («ya empezó el tratamiento: ¿cuál es el plan?»), baja un escalón solo si el médico abre la puerta («¿más o menos cuántos días? ¿habrá cirugía, más o menos cuándo?»), y lo técnico que detecte el análisis no se le lanza al médico: se vuelve una petición neutra (la hoja de medicamentos), se anota, o —si es un riesgo de seguridad— una sola duda en lenguaje llano. Máximo 1-2 preguntas por encuentro; el análisis completo queda en los documentos privados.
